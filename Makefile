...
run: all
	./build/master/master.bin models/CornellBoxDiffuse.blend --VCM --max-radius=0.01 --num-photons=2000000 --parallel --reference=models/CornellBoxDiffuse.exr
	# ./build/master/master.bin models/CornellBoxDiffuse.blend --PT
