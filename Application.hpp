...
private:
    static double _compute_rms(std::size_t width, std::size_t height, const glm::vec4* left, const glm::vec4* right);
    void _update_rms_history(std::size_t width, std::size_t height, const glm::vec4* data);
