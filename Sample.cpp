...
vec3 RandomEngine::random3() {
  return vec3(std::uniform_real_distribution<float>()(engine),
              std::uniform_real_distribution<float>()(engine),
              std::uniform_real_distribution<float>()(engine));
}

vec4 RandomEngine::random4() {
  return vec4(std::uniform_real_distribution<float>()(engine),
              std::uniform_real_distribution<float>()(engine),
              std::uniform_real_distribution<float>()(engine),
              std::uniform_real_distribution<float>()(engine));
}
...
const float DiskSample1::theta() const { return atan2(_point.y, _point.x); }

const float DiskSample1::radius() const { return length(_point); }
